    ...
    <>
      ...
      <div className='flex flex-col w-full mt-10 gap-5'>
        <div className='flex gap-5'>
          <div className='rounded-xl border bg-card text-card-foreground shadow-lg w-1/3 p-5'>
      ...
      <div className='rounded-xl border bg-card text-card-foreground shadow-lg p-5 mt-12 overflow-y-scroll h-96'>
  ...
  return (
    <>
      <Tabs
        ...
        className='flex flex-col justify-center items-center my-10 w-full pe-40'
      >
        <TabsList className='inline-flex h-16 w-60 gap-x-5 items-center justify-center rounded-lg bg-muted p-1 text-muted-foreground shadow-md'>
          <TabsTriggerBox value='shipment' onClick={() => getActiveTab("shipment")}>
            Shipments
          </TabsTriggerBox>
          <TabsTriggerBox
            value='container'
